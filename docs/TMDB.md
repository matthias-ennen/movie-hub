...
Für #256 ist zusätzlich eine TMDB-Änderungswarteschlange vorbereitet. Sie liest die offiziellen Film- und Serien-Änderungslisten vollständig über alle Ergebnisseiten, zerlegt längere Nachholzeiträume in zulässige Fenster von höchstens 14 Tagen und führt neue IDs mit noch offenen Änderungen zusammen. Suchdetails, Serienstaffeln, Waipu-Metadaten, Movie-Hub-Titel und persönliche TMDB-Katalogtitel können diese IDs vor dem normalen 30-Tage-Umlauf priorisieren. Der Erfolgs-Checkpoint wird technisch in einer Folgedatei vorbereitet und darf erst nach erfolgreicher Gesamtveröffentlichung übernommen werden. Die produktive Workflow-Aktivierung erfolgt erst zusammen mit der Quittierungslogik aller Verbraucher, damit weder Änderungen verloren gehen noch bereits verarbeitete Titel unnötig täglich erneut geladen werden.
