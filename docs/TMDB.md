...
Der Zeitplan ist täglich um **03:17 Uhr in `Europe/Berlin`** und folgt damit automatisch der deutschen Sommer- und Winterzeit; derselbe Workflow kann bei Bedarf auch manuell gestartet werden. Der Datenlauf protokolliert geplanten und tatsächlichen Start sowie die Verzögerung. Ein unabhängiger Wächter prüft um 05:47 Uhr, ob der Nachtlauf vorhanden und höchstens 60 Minuten verspätet ist, und markiert einen fehlenden, verspäteten oder fehlgeschlagenen Lauf sichtbar als Fehler. Schlägt ein Abruf, die Mindestprüfung oder der Build fehl, wird nichts veröffentlicht. Das bisherige funktionierende Katalog-Artefakt bleibt dann live.
