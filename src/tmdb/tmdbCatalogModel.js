...
export function normalizePersonalTmdbTitle(raw) {
  ...
  return {
    ...
    metadataChecks: raw.metadataChecks && typeof raw.metadataChecks === 'object' ? raw.metadataChecks : {},
    metadataUpdatedAt: raw.metadataUpdatedAt || raw.syncedAt || null,
    originalLanguage: raw.originalLanguage || null,
    runtimeMinutes: finiteNumber(raw.runtimeMinutes),
    numberOfSeasons: type === 'series' ? finiteNumber(raw.numberOfSeasons) : null,
    numberOfEpisodes: type === 'series' ? finiteNumber(raw.numberOfEpisodes) : null,
    seasons: type === 'series' && Array.isArray(raw.seasons) ? raw.seasons : [],
...
export function nativeTitleToFirestore(raw, syncedAt) {
  ...
  return {
    ...
    smartFacets: normalized.smartFacets,
